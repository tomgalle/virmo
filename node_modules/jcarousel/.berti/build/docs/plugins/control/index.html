...
<html>
    <head>
        ...
        <title>Control Plugin - jCarousel</title>
        ...
        <meta property="og:title" content="Control Plugin - jCarousel">
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h1>
<a name="control-plugin" class="anchor" href="#control-plugin"><span class="octicon octicon-link"></span></a>Control Plugin</h1>

<p>The jCarousel Control Plugin provides controls for jCarousel.</p>

<p>A control is basically a HTML element (<code>&lt;a&gt;</code>, <code>&lt;button&gt;</code> etc.) which scrolls
the carousel backward, forward or to a specific item when clicking on it.</p>
