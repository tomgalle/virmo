...
<html>
    <head>
        ...
        <title>Installation - jCarousel</title>
        ...
        <meta property="og:title" content="Installation - jCarousel">
...
<p>To setup autoscrolling, just call <code>jcarouselAutoscroll()</code> on the carousel root
element:</p>

<div class="highlight highlight-javascript"><pre><span class="nx">$</span><span class="p">(</span><span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
    <span class="nx">$</span><span class="p">(</span><span class="s1">'.jcarousel'</span><span class="p">)</span>
        <span class="p">.</span><span class="nx">jcarousel</span><span class="p">({</span>
            <span class="c1">// Core configuration goes here</span>
        <span class="p">})</span>
        <span class="p">.</span><span class="nx">jcarouselAutoscroll</span><span class="p">({</span>
            <span class="nx">interval</span><span class="o">:</span> <span class="mi">3000</span><span class="p">,</span>
            <span class="nx">target</span><span class="o">:</span> <span class="s1">'+=1'</span><span class="p">,</span>
...
<p>See <a href="configuration.html">Configuration</a> for more information about the
