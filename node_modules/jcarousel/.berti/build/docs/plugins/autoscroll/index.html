...
<html>
    <head>
        ...
        <title>Autoscroll Plugin - jCarousel</title>
        ...
        <meta property="og:title" content="Autoscroll Plugin - jCarousel">
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <h1>
<a name="autoscroll-plugin" class="anchor" href="#autoscroll-plugin"><span class="octicon octicon-link"></span></a>Autoscroll Plugin</h1>

<p>The jCarousel Autoscroll Plugin provides autoscrolling support for jCarousel.</p>
